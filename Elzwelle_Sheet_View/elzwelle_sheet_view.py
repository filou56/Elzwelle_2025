...
class sheetapp_tk(tkinter.Tk):
    ...
    def initialize(self):
        ...
        self.startSheet.enable_bindings("single_select","drag_select","row_select","copy")
        ...
        self.finishSheet.enable_bindings("single_select","drag_select","row_select","copy")
        ...
        self.courseSheet.enable_bindings("single_select","drag_select","row_select","copy")
        self.courseSheet.span('A').readonly()
        self.courseSheet.span('B').readonly()
        self.courseSheet.span('C').readonly()
        self.courseSheet.span('D').readonly()
...
if __name__ == '__main__':    
    ...
    app.title("MQTT Tabelle Elz-Zeit Viewer")
    app.refresh()
